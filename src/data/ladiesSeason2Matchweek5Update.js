...
function sync(){if(location.pathname!=='/leagues')return;if(document.querySelector('[data-ladies-mw5]'))return;const root=document.querySelector('.page');if(!root)return;const target=root.querySelector('[data-ladies-mw4]')||root.querySelector('[data-ladies-mw3]')||root.firstElementChild;target?.insertAdjacentHTML('afterend',block());}
