    ...
    score: { winner: 'away', totals: [6, 16], rubberWins: [2, 4],
      rubbers: [
        ...
        { slot: '19:15', court: 'P1', sets: [[2,6],[1,6],[3,10]], games: [0, 4], winner: 'away',
          homeIds: ids('globo-boomerangs', 'Liam Morgan', 'Lefa Mogamedi'), awayIds: ids('sonic-viboras', 'Yusuf Moola', 'Pieter Boshoff') },
        ...
        { slot: '20:30', court: 'P2', sets: [[3,6],[6,4],[9,11]], games: [3, 0], winner: 'home',
          homeIds: ids('globo-boomerangs', 'Muhammed Shehzad Meer', 'Bevin Francis'), awayIds: ids('sonic-viboras', 'Warwick Morgan', 'Joshua Hoffman') },
