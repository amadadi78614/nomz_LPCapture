...
function syncLadiesRankingsPage() {
  ...
  section.innerHTML=`
    ...
    <div class="card" style="border-left:4px solid #f0abcc;padding:18px">
      <span class="eyebrow">Ladies Season 2 · Through Matchweek 4 · 9 September 2026</span>
      <h2 class="display" style="margin:5px 0 6px">Official Player MVP Rankings</h2>
      <p class="muted" style="margin:0;font-size:12px">Updated from all verified played rubbers through 9 September 2026. 3 MVP points per rubber win + 1 bonus for a clean 4–0. Partners receive identical points. Administrative awards carry no player appearance, win, bonus or MVP credit.</p>
    </div>
    <div class="grid mt">
    ...
    <div class="card mt" style="padding:18px;overflow-x:auto">
      <span class="eyebrow">Ladies Season 2 · Franchise Log · Through Matchweek 4</span>
      <h3 class="display" style="margin:5px 0 8px">Standings through 9 September 2026</h3>
