...
export const FIXTURES = [
  ...
  { id: 'fx-w2-1', round: 2, league: 'mens', home: 'avalanche-aces', away: 'ice-breakers', start: T('2026-06-17'), status: 'final', court: 'Padel 24',
    score: { winner: 'away', totals: [7, 16], rubberWins: [1, 5], rubbers: [
      ...
      { slot: '19:15', court: 'P3', home: 'Rishaad Shaik / Prashil Nagar', away: 'Shaun Moropa / Aadam Nomani',
        homeIds: ids('avalanche-aces', 'Rishaad Shaik', 'Prashil Nagar'), awayIds: ids('ice-breakers', 'Aadam Nomani'), games: [0, 4], winner: 'away' },
