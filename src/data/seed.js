...
const SQUADS = {
  'avalanche-aces': {
    P1: ['Wiehann Mohlen', 'Hoffmann Maritz', 'Patrick Leyden', 'Donavan Taylor', 'Ryan Tate', 'Steven Pinker'],
  ...
  'globo-boomerangs': {
    P1: ['Yusuf Asvat', 'Joseph van der Merwe', 'Ahmed Mungalee', 'Liam Morgan', 'Lefa Moganedi', 'Adil Ahmed'],
    P2: ['Bevan Francis', 'Muhammed Shehzad Meer', 'Ryan Kennett', 'Diego Sebastian', 'Duran Greever', 'Nabeel Meer'],
...
export const FIXTURES = [
  ...
  { id: 'fx-w1-2', round: 1, league: 'mens', home: 'samurai-kicksmashers', away: 'avalanche-aces', start: T('2026-06-08'), status: 'final', court: 'Play 360', dh: true,
    score: { winner: 'home', totals: [12, 9], rubberWins: [3, 3], rubbers: [
      ...
      { slot: '19:15', court: 'P1', home: 'Durell Pillay / Bryan Theron', away: 'Patrick Leyden / Hoffman Maritz',
        homeIds: ids('samurai-kicksmashers', 'Durell Pillay', 'Bryan Theron'), awayIds: ids('avalanche-aces', 'Patrick Leyden', 'Hoffmann Maritz'), games: [4, 0], winner: 'home' },
  ...
  { id: 'fx-w1-3', round: 1, league: 'mens', home: 'desert-falcons', away: 'avalanche-aces', start: T('2026-06-10'), status: 'final', court: 'Padel 24', dh: true,
    score: { winner: 'home', totals: [21, 0], rubberWins: [6, 0], rubbers: [
      ...
      { slot: '19:15', court: 'P1', home: 'Ahmed Ismail / Faheem Nomani', away: 'Donovan Taylor / Ryan Tate',
        homeIds: ids('desert-falcons', 'Ahmed Ismail', 'Faheem Nomani'), awayIds: ids('avalanche-aces', 'Donavan Taylor', 'Ryan Tate'), games: [4, 0], winner: 'home' },
      ...
      { slot: '20:30', court: 'P1', home: 'Uwaiz Patel / Yusuf Patel', away: 'Patrick Leyden / Hoffman Maritz',
        homeIds: ids('desert-falcons', 'Uwaiz Patel', 'Yusuf Patel'), awayIds: ids('avalanche-aces', 'Patrick Leyden', 'Hoffmann Maritz'), games: [4, 0], winner: 'home' },
  ...
  { id: 'fx-w1-4', round: 1, league: 'mens', home: 'globo-boomerangs', away: 'sahara-lions', start: T('2026-06-10'), status: 'final', court: 'Play 360',
    score: { winner: 'away', totals: [8, 15], rubberWins: [2, 4], rubbers: [
      { slot: '18:00', court: 'P2', home: 'Momo / Bevin Francis', away: 'Naeem Omar / Alfaiz Mamji',
        homeIds: ids('globo-boomerangs', 'Muhammed Shehzad Meer', 'Bevan Francis'), awayIds: ids('sahara-lions', 'Naeem Omar', 'Alfaiz Mamji'), games: [4, 0], winner: 'home' },
  ...
  { id: 'fx-w2-1', round: 2, league: 'mens', home: 'avalanche-aces', away: 'ice-breakers', start: T('2026-06-17'), status: 'final', court: 'Padel 24',
    score: { winner: 'away', totals: [7, 16], rubberWins: [2, 4], rubbers: [
      { slot: '18:00', court: 'P1', home: 'Steven Pinker / Donovan Taylor', away: 'Imaad Arabi / Salmaan Methar',
        homeIds: ids('avalanche-aces', 'Steven Pinker', 'Donavan Taylor'), awayIds: ids('ice-breakers', 'Imaad Arabi', 'Salmaan Methar'), games: [0, 4], winner: 'away' },
  ...
  { id: 'fx-w2-3', round: 2, league: 'mens', home: 'globo-boomerangs', away: 'desert-falcons', start: T('2026-06-18'), status: 'final', court: 'Padel 24', tossWonBy: 'desert-falcons',
    score: { winner: 'away', totals: [3, 19], rubberWins: [1, 5], rubbers: [
      ...
      { slot: '19:15', court: 'P2', home: 'Momo / Bevan', away: 'Warno / Morne',
        homeIds: ids('globo-boomerangs', 'Muhammed Shehzad Meer', 'Bevan Francis'), awayIds: ids('desert-falcons', 'Warno Smit', 'Morne Steenekamp'),
  ...
  { id: 'fx-w3-1', round: 3, league: 'mens', home: 'avalanche-aces', away: 'sonic-viboras', start: T('2026-06-22'), status: 'final', court: 'Play 360', dh: true,
    score: { winner: 'draw', totals: [10, 10], rubberWins: [3, 3], rubbers: [
      { slot: '18:00', court: 'P1', home: 'Hoffman Maritz / Wiehann Mohlen', away: 'Heinrich Coomans / Anton Grote',
        homeIds: ids('avalanche-aces', 'Hoffmann Maritz', 'Wiehann Mohlen'), awayIds: ids('sonic-viboras', 'Heinrich Coomans', 'Anton Grote'), games: [0, 3], winner: 'away', sets: [[2, 6], [6, 1], [7, 10]] },
      ...
      { slot: '19:15', court: 'P1', home: 'Patrick Leyden / Donovan Taylor', away: 'Yusuf Moola / Pieter Boshoff',
        homeIds: ids('avalanche-aces', 'Patrick Leyden', 'Donavan Taylor'), awayIds: ids('sonic-viboras', 'Yusuf Moola', 'Pieter Boshoff'), games: [0, 4], winner: 'away', sets: [[2, 6], [1, 6], [5, 10]] },
  ...
  { id: 'fx-w3-3', round: 3, league: 'mens', home: 'globo-boomerangs', away: 'sonic-viboras', start: T('2026-06-24'), status: 'final', court: 'Padel 24', dh: true,
    score: { winner: 'away', totals: [6, 16], rubberWins: [2, 4],
      rubbers: [
        { slot: '18:00', court: 'P1', sets: [[3,6],[5,7],[9,11]], games: [0, 4], winner: 'away',
          homeIds: ids('globo-boomerangs', 'Ahmed Mungalee', 'Yusuf Asvat'), awayIds: ids('sonic-viboras', 'Heinrich Coomans', 'Anton Grote') },
        { slot: '18:00', court: 'P3', sets: [[6,7],[2,6],[12,14]], games: [0, 4], winner: 'away',
          homeIds: ids('globo-boomerangs', 'Taahir Mungalee', 'Kiran Hansraj'), awayIds: ids('sonic-viboras', 'George du Toit', 'Dewald Meyer') },
        { slot: '19:15', court: 'P1', sets: [[2,6],[1,6],[3,10]], games: [0, 4], winner: 'away',
          homeIds: ids('globo-boomerangs', 'Liam Morgan', 'Lefa Moganedi'), awayIds: ids('sonic-viboras', 'Yusuf Moola', 'Pieter Boshoff') },
        { slot: '19:15', court: 'P2', sets: [[6,4],[4,6],[8,10]], games: [3, 0], winner: 'home',
          homeIds: ids('globo-boomerangs', 'Ryan Kennett', 'Diego Sebastian'), awayIds: ids('sonic-viboras', 'Marius Loock', 'Khalid Jeewa') },
        { slot: '20:30', court: 'P2', sets: [[3,6],[6,4],[9,11]], games: [3, 0], winner: 'home',
          homeIds: ids('globo-boomerangs', 'Muhammed Shehzad Meer', 'Bevan Francis'), awayIds: ids('sonic-viboras', 'Warwick Morgan', 'Joshua Hoffman') },
        { slot: '20:30', court: 'P3', sets: [[7,5],[6,3],[10,2]], games: [0, 4], winner: 'away',
  ...
  { id: 'fx-w3-4', round: 3, league: 'mens', home: 'sahara-lions', away: 'ice-breakers', start: T('2026-06-24'), status: 'final', court: 'Play 360',
    score: { winner: 'away', totals: [6, 15], rubberWins: [2, 4],
      rubbers: [
        { slot: '18:00', court: 'P1', sets: [[6,1],[7,6],[7,10]], games: [3, 0], winner: 'home',
          homeIds: ids('sahara-lions', 'Cameron Jacobsz', 'Yusuf Packery'), awayIds: ids('ice-breakers', 'Duhan Swart', 'JD Herbst') },
        { slot: '18:00', court: 'P3', sets: [[4,6],[6,7],[7,10]], games: [0, 4], winner: 'away',
          homeIds: ids('sahara-lions', 'Drikus Prins', 'Warren Morgan'), awayIds: ids('ice-breakers', 'Wayne Enslin', 'Sergio Correia') },
        { slot: '19:15', court: 'P1', sets: [[7,5],[4,6],[10,8]], games: [3, 0], winner: 'home',
          homeIds: ids('sahara-lions', 'Pieter Badenhorst', 'Justin van Staaden'), awayIds: ids('ice-breakers', 'Maaz Randera', 'Zaheer Methar') },
        { slot: '19:15', court: 'P2', sets: [[2,6],[6,3],[4,10]], games: [0, 3], winner: 'away',
          homeIds: ids('sahara-lions', 'Suliman Patel', 'Irfaan Mamji'), awayIds: ids('ice-breakers', 'Zahid Methar', 'Chaz Taylor') },
        { slot: '20:30', court: 'P2', sets: [[4,6],[2,6],[3,10]], games: [0, 4], winner: 'away',
          homeIds: ids('sahara-lions', 'Naeem Omar', 'Alfaiz Mamji'), awayIds: ids('ice-breakers', 'Jacques Van Zyl', 'Nicky Joubert') },
        { slot: '20:30', court: 'P3', sets: [[5,7],[5,7],[6,10]], games: [0, 4], winner: 'away',
...
export const NEWS = [
  { id: 'ladies-s2-playoffs', league: 'ladies', kicker: 'Ladies Season 2 · Playoffs Next', tag: 'ladies', date: '2026-09-23', href: '/live',
    title: 'The final four are set for the Ladies Season 2 playoffs',
    body: 'Backhand Blossoms, Lunar Lillies, Phoenix Flames and Net Novas have secured the four playoff places. The confirmed bracket, venues and court times will be published in the Match Centre.',
  },
  { id: 'ladies-s2-mw5', league: 'ladies', kicker: 'Matchweek 5 · Complete', tag: 'ladies', date: '2026-09-16', href: '/live',
    title: 'Lillies roar, Flames win and Blossoms hold top spot',
    body: 'Lunar Lillies handed Backhand Blossoms their first defeat with an 11–4 statement win. Phoenix Flames beat Desert Roses 10–3, while Arctic Angels edged Net Novas 7–6.',
  },
  { id: 'legacy-2026-champions', league: 'legacy', kicker: 'Legacy League 2026 · The Podium', tag: 'legacy', date: '2026-09-20', href: '/leagues?league=legacy',
    title: 'LP Honey Badgers crowned inaugural Legacy champions',
    body: 'Legacies are earned. LP Honey Badgers claimed the championship, LP Cheetahs finished runners-up and LP Rhinos completed the podium after a season built on competition, family and belonging.',
  },
  { id: 'super-cup-2026-podium', league: 'supercup', kicker: '360 Super Cup · Final Standings', tag: 'supercup', date: '2026-08-30', href: '/360-super-cup',
    title: 'Lowveld Padel finishes third on the national stage',
    body: 'Lowveld completed 20 matches with 10 wins, 28 points and a +7 game differential to seal third place at the 2026 360 Super Cup in Johannesburg.',
  },
  { id: 'mens-s3-champions', league: 'mens', kicker: "Men's Season 3 · Champions", tag: 'mens', date: '2026-08-14', href: '/leagues',
    title: 'Desert Falcons dethrone the champions in the Grand Final',
    body: 'Desert Falcons defeated Sonic Viboras 14–8 to claim the Season 3 title, breaking away from 4–4 and ending the Viboras’ run as back-to-back champions.',
  },
  { id: 'mens-s3-podium', league: 'mens', kicker: "Men's Season 3 · Final Chapter", tag: 'mens', date: '2026-08-16', href: '/leagues',
    title: 'Season 3 closes with a new champion and a complete archive',
    body: 'The final standings, playoff results, franchise records and MVP honours from Season 3 are now preserved in the Leagues and Match Centre archives.',
  },
];
